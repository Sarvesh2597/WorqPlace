                                        ...
                                        <Row style={{display:'flex', justifyContent:'center'}}>
                                            <Col md={6} className="p-5 position-relative">
                                                ...
                                                {this.props.passwordResetStatus ? 
                                                        <Alert color="success">Reset password link is sent to your email. Please check your email..</Alert>
                                                    : null
                                                }
                                                ...
                                                <AvForm onValidSubmit={this.handleValidSubmit} className="authentication-form">
                                                    <AvGroup className="">
                                                        ...
                                                        <InputGroup>
                                                            ...
                                                            <AvInput type="text" name="email" id="email" placeholder="xyz@xyz.com" 
