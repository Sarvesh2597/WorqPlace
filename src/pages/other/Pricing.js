...
const Pricing = () => {
    const plans = [
        ...
        },
        {
            ...
            icon: ShoppingBag,
            price: '$49',
            features: ['100 GB Storage', 'Unlimited Bandwidth', '10 Domain', 'Email Support', '24x7 Support'],
            isRecommended: false,
        },
    ];
                                        ...
                                        <CardBody className="p-4">
                                            <Media>
                                                <Media body>
                                                    ...
                                                    <h2 className="mt-0 mb-2">
                                                        {plan.price} <span className="font-size-14">/ Month</span>
                                                    </h2>
                                                </Media>
                                            ...
                                            <ul className="card-pricing-features text-muted border-top pt-2 mt-2 pl-0 list-unstyled">
                                                {plan.features.map((feature, idx1) => {
                                                    return (
                                                        <li key={idx1}>
                                                            <i className="uil uil-check text-success font-size-15 mr-1"></i>
                                                            {feature}
                                                        </li>
                                                    );
                                                })}
                                            ...
                                            <div className="mt-5 text-center">
                                                <button
                                                    ...
                                                    <i className="uil uil-arrow-right mr-1"></i>Buy Now for {plan.price}
                                                </button>
                                            </div>
                                        </CardBody>
                                    </Card>
