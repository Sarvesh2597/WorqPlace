                ...
                <Col>
                    <Card>
                        <CardBody>
                            ...
                            <p className="mb-3">
                                Use <code>&lt;i data-feather="activity"&gt;&lt;/i&gt;</code>.
                            </p>
                ...
                <Col>
                    <Card>
                        <CardBody>
                            ...
                            <p className="mb-3">
                                Use <code>&lt;i data-feather="activity" class="icon-dual"&gt;&lt;/i&gt;</code>.
                            </p>
                ...
                <Col>
                    <Card>
                        <CardBody>
                            ...
                            <p className="mb-3">
                                Use <code>&lt;i data-feather="activity" class="icon-**"&gt;&lt;/i&gt;</code>. Available
