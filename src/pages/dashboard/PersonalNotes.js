...
class Tasks extends Component {
    ...
    getPersonalNotes = () => {
        fetch(BASE_URL + '/notes/personal/' + this.state.selectedTeam._id, {
            headers: {
    ...
    createNote = (data) => {
        fetch(BASE_URL + '/notes/create/personal/', {
            method: 'POST',
            body: JSON.stringify({
        ...
        return (
            <Card className="grid-cards">
                <CardBody className="pt-2 pb-0">
                    ...
                    />
                    <h3 className="mb-3 header-title">Personal Notes</h3>
                        ...
                        <div>
                            <div>
                                ...
                                <div id="accordion" className="accordion custom-accordionwitharrow mt-4">
                                    ...
                                    )): 'Personal notes are not created yet.'}
                                </div>
                            </div>
                        </div>
                    </PerfectScrollbar>
