...
import { Button, Card, CardBody, Col, CustomInput, DropdownItem, DropdownMenu, DropdownToggle, Media, Modal, ModalBody, ModalHeader, Row, UncontrolledDropdown, UncontrolledTooltip } from 'reactstrap';
            ...
            <div className="p-1 px-2">
                <Row className="align-items-center">
                    ...
                    <Col className="col-auto">
                        ...
                        <UncontrolledTooltip placement="bottom" target={`btn-d-${item.id}`}>
                            Download
                        </UncontrolledTooltip>
                        ...
                        <UncontrolledTooltip placement="bottom" target={`btn-dl-${item.id}`}>
                            Delete
                        </UncontrolledTooltip>
                    </Col>
                </Row>
                    ...
                    <Row className="pb-3 border-bottom">
                        <Col>
                            ...
                            <Modal isOpen={modal} toggle={showModal}>
                                <ModalHeader toggle={hideModal}>Task Confirmation</ModalHeader>
                                <ModalBody>
                                    <Card className="mb-1">
                                        <CardBody>
                                ...
                                <div className="button-align mb-3">
