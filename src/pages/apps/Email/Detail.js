...
import { Button, ButtonGroup, Card, Col, Media, Row, UncontrolledTooltip } from 'reactstrap';
                    ...
                    <Col className="col-12">
                        <div className="email-container">
                            ...
                            <div className="inbox-rightbar p-4">
                                <ButtonGroup className="mr-1 float-right">
                                ...
                                <ButtonGroup className="mr-1 float-right">
                                    <Button id="Replylater" color="danger">
                                        <i className="uil uil-envelope-edit"></i>
                                    </Button>
                                    <UncontrolledTooltip placement="top" target="Replylater">Reply Later</UncontrolledTooltip>
                                </ButtonGroup>
                                ...
                                <div className="mt-3">
                                    ...
                                    <h5 className="mb-0 mt-5 header-title">Reply</h5>

                                    <Media className="mb-0 mt-4">
