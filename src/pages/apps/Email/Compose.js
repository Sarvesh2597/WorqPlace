                        ...
                        <div className="email-container">
                            ...
                            <div className="inbox-rightbar p-4">
                                <AvForm onValidSubmit={this.handleSave}>
                                    <AvField type="email" name="to" placeholder="To" required></AvField>
                                    <AvField type="text" name="subject" placeholder="Subject" required></AvField>

                                    <Row>
                                        <Col className="min-height">
                                            <RichTextEditor className="min-height" onEditorContentChange={this.onEditorContentChange} />
                                        </Col>
                                    </Row>
