...
const MenuItemWithChildren = ({ item, linkClassNames, subMenuClassNames, activatedMenuItemIds }) => {
    ...
    return (
        ((item.name === 'Dashboard' || item.name === 'Boards' || item.name === 'Docs' || item.name === 'Account' || item.name === 'Chats' || item.name === 'Members') &&
...
const MenuItem = ({ item, className, linkClassName }) => {
    return (
        ((item.name === 'Dashboard' || item.name === 'Boards' || item.name === 'Docs' || item.name === 'Account' || item.name ==='Chats' || item.name === 'Members') &&
            <li className={classNames('side-nav-item', className)} style={{ marginTop: '7px', marginBottom: '7px' }}>
